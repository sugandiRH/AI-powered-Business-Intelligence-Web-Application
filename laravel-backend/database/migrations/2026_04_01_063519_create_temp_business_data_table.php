...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('temp_business_data', function (Blueprint $table) {
            ...
            $table->text('validation_severity')->nullable();
            ...
            $table->decimal('mean_price', 10, 2)->nullable();
            $table->decimal('mean_quantity', 10, 2)->nullable();       
            
            $table->boolean('user_confirmed')->default(false);

            $table->boolean('ai_correction')->default(false);
            $table->text('ai_field_corrected')->nullable();
            $table->text('cleaned_data')->nullable();
